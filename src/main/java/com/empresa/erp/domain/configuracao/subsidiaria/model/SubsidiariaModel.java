...
@Table(name = "subsidiaria")
@Entity(name = "SubsidiariaModel")
@Getter
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(of = "id", callSuper = false)
public class SubsidiariaModel extends AuditoriaModel {
    ...
    public void atualizar(AtualizaSubsidiariaRecord dados) {
