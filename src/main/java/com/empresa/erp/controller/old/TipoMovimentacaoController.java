...
import com.empresa.erp.domain.old.AtualizaTipoMovimentacaoRecord;
import com.empresa.erp.domain.old.DetalheTipoMovimentacaoRecord;
import com.empresa.erp.domain.old.ListaTipoMovimentacaoRecord;
import com.empresa.erp.domain.old.TipoMovimentacaoRecord;
import com.empresa.erp.domain.old.TipoMovimentacaoService;
...
public class TipoMovimentacaoController {
	...
	@GetMapping
	public ResponseEntity<Page<ListaTipoMovimentacaoRecord>> listar(@PageableDefault(page = 0, size = 10, sort = "id", direction = Sort.Direction.DESC) Pageable paginacao){
		try {
