...
import com.empresa.erp.domain.estoque.compraItem.service.CompraItemService;
...
public class CompraItemController {
	...
	@GetMapping
	public ResponseEntity<Page<ListaCompraItemRecord>> listar(@PageableDefault(page = 0, size = 10, sort = "id", direction = Sort.Direction.DESC) Pageable paginacao, String filtro){
		try {
