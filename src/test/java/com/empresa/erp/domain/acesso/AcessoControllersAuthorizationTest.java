...
class AcessoControllersAuthorizationTest {
    ...
    @Test
    @DisplayName("Deve validar permissoes do UsuarioEmpresaController")
    void deveValidarPermissoesDoUsuarioEmpresaController() throws Exception {
        assertThat(preAuthorize(UsuarioEmpresaController.class, "cadastrar", UsuarioEmpresaRecord.class, UriComponentsBuilder.class))
                .isEqualTo("hasAuthority('ACESSO_USUARIO_EMPRESA_CRIAR')");

        assertThat(preAuthorize(UsuarioEmpresaController.class, "listar", Pageable.class, Long.class, Long.class))
                .isEqualTo("hasAuthority('ACESSO_USUARIO_EMPRESA_LISTAR')");

        assertThat(preAuthorize(UsuarioEmpresaController.class, "listarEmpresas", Pageable.class, String.class))
                .isEqualTo("hasAuthority('ACESSO_USUARIO_EMPRESA_CRIAR')");

        assertThat(preAuthorize(UsuarioEmpresaController.class, "detalhar", Long.class))
                .isEqualTo("hasAuthority('ACESSO_USUARIO_EMPRESA_DETALHAR')");

        assertThat(preAuthorize(UsuarioEmpresaController.class, "atualizar", AtualizaUsuarioEmpresaRecord.class))
                .isEqualTo("hasAuthority('ACESSO_USUARIO_EMPRESA_EDITAR')");

        assertThat(preAuthorize(UsuarioEmpresaController.class, "excluir", Long.class))
                .isEqualTo("hasAuthority('ACESSO_USUARIO_EMPRESA_EXCLUIR')");
    }
    ...
    void deveValidarPermissoesDoUsuarioController() throws Exception {
        ...
        assertThat(preAuthorize(UsuarioController.class, "listar", Pageable.class, String.class, StatusEnum.class))
