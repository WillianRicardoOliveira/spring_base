...
class SubsidiariaResponseRecordsTest {
    ...
    void deveCriarDetalheAPartirDoModel() {
        ...
        var detalhe =
                new DetalheSubsidiariaRecord(subsidiaria);

        assertThat(detalhe.id()).isEqualTo(2L);
        assertThat(detalhe.idEmpresa()).isEqualTo(1L);
    ...
    void deveCriarItemDeListagemAPartirDoModel() {
        ...
        var lista =
                new ListaSubsidiariaRecord(subsidiaria);

        assertThat(lista.id()).isEqualTo(2L);
        assertThat(lista.idEmpresa()).isEqualTo(1L);
