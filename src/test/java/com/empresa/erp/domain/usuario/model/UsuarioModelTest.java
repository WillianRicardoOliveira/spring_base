...
class UsuarioModelTest {
    ...
    @Test
    @DisplayName(
            "Deve criar usuario ativo com email normalizado"
    )
    ...
    @Test
    @DisplayName(
            "Deve remover usuario registrando auditoria"
    )
    ...
    @Test
    @DisplayName(
            "Deve aceitar email nulo na normalizacao interna"
    )
