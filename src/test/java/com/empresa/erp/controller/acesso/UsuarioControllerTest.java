...
class UsuarioControllerTest {
    ...
    @Test
    @DisplayName(
            "Deve cadastrar usuario e retornar status 201"
    )
    ...
    @Test
    @DisplayName(
            "Deve retornar 400 ao cadastrar usuario "
                    + "com email em branco"
    )
    ...
    void deveDetalharUsuario()
            throws Exception {
        var detalhe = new DetalheUsuarioRecord(
                1L,
                "usuario@teste.com",
                StatusEnum.ATIVO
        );
    ...
    @Test
    @DisplayName(
            "Deve inativar vinculo do usuario "
                    + "e retornar status 204"
    )
