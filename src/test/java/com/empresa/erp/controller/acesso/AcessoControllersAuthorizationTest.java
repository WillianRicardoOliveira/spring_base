...
class AcessoControllersAuthorizationTest {
    ...
    void deveValidarPermissoesDoPerfilController()
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_PERFIL_CRIAR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_PERFIL_LISTAR')"
        );

        assertThat(preAuthorize(
                PerfilController.class,
                "atualizar",
                AtualizaPerfilRecord.class
        )).isEqualTo(
                "hasAuthority('ACESSO_PERFIL_EDITAR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_PERFIL_EXCLUIR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_PERFIL_DETALHAR')"
        );
    }
    ...
    void deveValidarPermissoesDoPermissaoController()
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_PERMISSAO_DETALHAR')"
        );
    }
    ...
    void deveValidarPermissoesDoPerfilPermissaoController()
            throws Exception {
        assertThat(preAuthorize(
                PerfilPermissaoController.class,
                "cadastrar",
                PerfilPermissaoRecord.class,
                UriComponentsBuilder.class
        )).isEqualTo(
                "hasAuthority('ACESSO_PERFIL_PERMISSAO_CRIAR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_PERFIL_PERMISSAO_LISTAR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_PERFIL_PERMISSAO_EXCLUIR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_PERFIL_PERMISSAO_DETALHAR')"
        );
    }
    ...
    void deveValidarPermissoesDoUsuarioPerfilController()
            throws Exception {
        assertThat(preAuthorize(
                UsuarioPerfilController.class,
                "cadastrar",
                UsuarioPerfilRecord.class,
                UriComponentsBuilder.class
        )).isEqualTo(
                "hasAuthority('ACESSO_USUARIO_PERFIL_CRIAR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_USUARIO_PERFIL_LISTAR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_USUARIO_PERFIL_EXCLUIR')"
        );
        ...
        assertThat(preAuthorize(
                ...
                "hasAuthority('ACESSO_USUARIO_PERFIL_DETALHAR')"
        );
    }
    ...
    void deveValidarPermissoesDoUsuarioEmpresaController()
        ...
        assertThat(preAuthorize(
                UsuarioEmpresaController.class,
                "atualizar",
                AtualizaUsuarioEmpresaRecord.class
        )).isEqualTo(
    ...
    void deveValidarPermissoesDoUsuarioSubsidiariaController()
            throws Exception {
        assertThat(preAuthorize(
                UsuarioSubsidiariaController.class,
                "cadastrar",
                UsuarioSubsidiariaRecord.class,
                UriComponentsBuilder.class
        )).isEqualTo(
